...
abstract class AppColors {
  ...
  static const Color white21 = Color(0x36FFFFFF); // Second Background Color
  static const Color black2727 = Color(0xFF272727); // Second Background Color
  static const Color black = Color(0xFF000000); // Second Background Color
  static const Color greyAF = Color(0xFFAFAFAF); // Second Background Color
}